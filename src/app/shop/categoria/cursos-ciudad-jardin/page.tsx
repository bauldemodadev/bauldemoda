        ...
        >
          ...
          <nav className="mb-6">
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>/</span>
              <Link href="/shop/categoria/cursos-ciudad-jardin" className="hover:text-[#E9ABBD]">
                Cursos Ciudad Jardín
              </Link>
              <span>/</span>
              <Link href="/shop/categoria/cursos-ciudad-jardin" className="text-[#E9ABBD] hover:text-[#D44D7D]">
                {title}
              </Link>
              <span>→</span>
            </div>
